...
public class Server implements ServerInfo{
	...
	private Map<String,ClientSocket> clientsMap=new HashMap<String,ClientSocket>();
			...
			try {
				...
				while (true) {
					...
					if(string!=null){
						...
						switch (strings[0]) {
						case "login":
							String sql = "select count(*) from people where name='" + strings[1] + "' and password='" + strings[2] + "'";
							String result=null;
							try {
